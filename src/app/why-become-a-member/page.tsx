...
export const metadata: Metadata = {
  ...
  description: "Discover the networking, education, visibility, and advocacy benefits of membership.",
};
    ...
    <>
      ...
      <section className="bg-primary py-20">
        <div className="section-container">
          ...
          <h1 className="heading-2xl text-white">Why Become a Member</h1>
        </div>
      </section>
