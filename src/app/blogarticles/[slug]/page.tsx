...
export default function BlogPostPage() {
  return (
    <>
      {/* Article header */}
      <section className="border-b border-slate-200 py-12 bg-white">
        <div className="section-container max-w-3xl">
          <Link
            href="/blogarticles"
            className="text-xs font-semibold uppercase tracking-widest text-teal hover:text-teal-dark transition-colors mb-6 inline-block"
          >
            ← Back to Blog
          </Link>
      ...
      <section className="py-14 bg-white">
        <div className="section-container max-w-3xl space-y-10">
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3 pl-5 list-disc font-body text-base text-slate-600 leading-relaxed">
              <li>
          ...
          <blockquote className="border-l-4 border-teal pl-6 py-1">
            <p className="font-body text-base text-slate-700 leading-relaxed italic">
