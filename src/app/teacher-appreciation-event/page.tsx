...
export const metadata: Metadata = {
  title: "Teacher Appreciation Event",
  description: "Celebrating the outstanding educators of Riverton, Herriman, and Bluffdale.",
};
    ...
    <>
      ...
      <section className="bg-primary py-20">
        <div className="section-container">
          ...
          <h1 className="heading-2xl text-white">Teacher Appreciation Event</h1>
        </div>
      </section>
