...
export const metadata: Metadata = {
  title: "Knight of Heroes Event",
  description: "Honoring police, fire, healthcare, and business heroes of the Southwest Valley.",
};
    ...
    <>
      ...
      <section className="bg-primary py-20">
        <div className="section-container">
          ...
          <h1 className="heading-2xl text-white">Knight of Heroes Event</h1>
        </div>
      </section>
